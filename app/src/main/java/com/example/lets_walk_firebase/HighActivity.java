...
public final class HighActivity extends Activity implements OnFullscreenListener {
    ...
    public static final class VideoListFragment extends ListFragment {
        ...
        static {
            ...
            list.add(new VideoEntry("단기간 살빠지는 최고의 운동", "MMswNnLdHso"));
            list.add(new VideoEntry("집에서 칼로리 불태우는 최고의 운동", "lKwZ2DU4P-A"));
            list.add(new VideoEntry("9분 살빠지는 다이어트 운동", "h9E_JHENdNI"));
            list.add(new VideoEntry("2100칼로리를 10분만에 써버리는 운동", "ZZ0rheDg7AQ"));
            list.add(new VideoEntry("10분전신 타바타 운동", "D8z8nN_u7CM"));
